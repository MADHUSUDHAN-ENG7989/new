export const Bio = {
    ...
    description: "Motivated and detail-oriented Computer Science student with a strong foundation in web development technologies including HTML, CSS, JavaScript, and React. Skilled in building responsive and user-friendly web applications, with hands-on experience in both front-end and back-end development. Enthusiastic about learning new frameworks and applying problem-solving skills to create efficient digital solutions. Seeking an internship opportunity in Web Development to contribute technical expertise, enhance practical knowledge, and grow as a professional in a dynamic team environment.",
